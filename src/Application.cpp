...
Application::Application()
    ...
    cube(shader) {
    shader.use();
    shader.setVec3("lightPos", glm::vec3(1.2f, 1.0f, 2.0f)); // add this line
...
void Application::run() {
    ...
    while (!window.shouldClose()) {
        ...
        shader.setVec4("objectColor", glm::vec4(0.5f, 0.5f, 0.5f, 1.0f));  // gray color, note that the name is now 'objectColor'
        grid.drawGrid();
